  ...
  return (
    <View className="mb-8">
      <View className="flex-row my-3">
        <View className={`mr-3 w-[36px] h-[36px] items-center justify-center`}>
          <Progress.Circle
            progress={progress}
            thickness={3}
            borderWidth={0}
            unfilledColor="#e5e7eb"
            color={status != "uncompleted" ? "#afdeb5" : "none"}
            strokeCap="round"
          />
        ...
        >
          ...
          <Text className="mt-2 text-xs font-openSans text-dark-lighter">
            {description}
          </Text>
          ...
          <View className="mt-3 flex-row items-center justify-between">
            <View className="flex-row items-center space-x-1.5">
              ...
              <View className="flex-row items-center">
                ...
                />
                <Text className="ml-1 text-2xs text-gray-500 font-openSans">
                  {time}
                </Text>
              </View>
            </View>
            ...
            {status == "completed" ? (
              ...
              <CustomButton
                ...
                className="bg-green-light/80 shadow-none p-1 px-2 rounded-md"
                IconRight={() => (
                  <Image
                    source={icons.check}
                    tintColor="#36633e"
              ...
              <View className="bg-primary-500/75 p-1 px-2 rounded-md flex-row items-center justify-center">
      ...
      {!lastLesson && (
        <View
          className={`${lessonSequence <= lessonsCompleted ? "bg-[#afdeb5]" : "bg-gray-200"} 
