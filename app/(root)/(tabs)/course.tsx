import { Image, Text, StyleSheet, View, Animated, LayoutChangeEvent, TouchableOpacity, ActivityIndicator, RefreshControl } from "react-native";
    ...
    <View className="h-full bg-white">
      ...
      {loading ? 
        ...
        <Animated.ScrollView 
          ...
          refreshControl={
            <RefreshControl refreshing={refreshing} onRefresh={onRefresh} style={{ transform: [{ scale: 0.75 }] }}/>
          } 
        >
          <View className="mx-4 mt-4 mb-5 flex-row items-center justify-between">
            <View className="flex-row items-center">
              ...
              >
                <Text className={`${!showCompletedCourses ? "text-white font-bold" : "text-dark-lighter font-medium"} text-xs`}>
                  Ongoing
                </Text>
                <Image 
          ...
          <View className="mx-4 my-2 mt-5 flex-row items-center justify-between">
            <Text className="text-base font-semibold text-dark-base">Explore</Text>
            <Text className="text-xs font-light text-dark-base">All shown</Text>
          </View>
