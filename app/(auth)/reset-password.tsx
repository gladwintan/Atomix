        ...
        <View className="flex-1 bg-white">
          ...
          <View className="p-5">
            {!passwordResetForm.codeGenerated ? (
              <View>
                <InputTextField
                  ...
                  onChangeText={(email) =>
                    setPasswordResetForm({ ...passwordResetForm, email: email })
                  }
                  icon={icons.email}
                />
            ...
            {passwordResetForm.error && (
              <Text className="p-3 mt-5 text-center text-base text-red-500">
                {passwordResetForm.error}
              </Text>
            )}

            <Link href="/sign-in" className="text-base text-center mt-8">
